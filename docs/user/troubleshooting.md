...
This guide helps you diagnose and fix common problems with Auxin for Logic Pro.
...
### Auxin.app Won't Open

**Symptom:** App bounces in dock and closes, or shows error dialog

**Cause 1: Unsigned App**
```
"Auxin.app" cannot be opened because the developer cannot be verified
```

**Solution:**
1. Right-click `Auxin.app` in Applications
2. Select "Open"
...
```
"Auxin.app" is damaged and can't be opened
```
...
- Auxin.app shows "Daemon Offline"
...
# If missing, reinstall Auxin.app
```
...
# Reinstall Auxin.app (will recreate plist)
# Then load:
launchctl load ~/Library/LaunchAgents/com.auxin.agent.plist
```
...
**Solution:** Add Auxin-LaunchAgent to Full Disk Access list
...
**Symptom:** Activity Monitor shows Auxin-LaunchAgent using >1GB RAM.
...
**Symptom:** Auxin-LaunchAgent constantly uses 20-50%+ CPU.
...
2. In Auxin.app, click "Force Break"
3. Confirm action
